package com.mt.spring.framework.v2;

import com.mt.spring.annotation.*;
...
//    }
            ...
            if(parameterType == HttpServletRequest.class){
                ...
                for (int j = 0; j < pa.length ; j ++) {
                    for(Annotation a : pa[i]){
                        if(a instanceof MtRequestParam){
                            String paramName = ((MtRequestParam) a).value();
    ...
    public void init(ServletConfig config) throws ServletException {
        ...
        System.out.println("Mt Spring framework is init.");
    }
    ...
    private void initHandlerMapping() {
        ...
        for (Map.Entry<String, Object> entry : ioc.entrySet()) {
            ...
            if(!clazz.isAnnotationPresent(MtController.class)){ continue; }
